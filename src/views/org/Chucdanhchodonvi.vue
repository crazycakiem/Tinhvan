    ...
    <b-col lg="12">
      <b-card class="card-de1">
        <div class="panel-title-de1">
          <div>
            <h4>"OrgTitle"</h4>
            <b-button id="btnAdd" @click="ShowOrgTitle" class="btn-pill mr-1" variant="default" size="sm">
              'Add' <i class="icon-plus"></i>
            </b-button>
            <b-button id="btnShowEdit" @click="ShowEdit" class="btn-pill mr-1" variant="default" size="sm" v-if="editchecked">
              'Edit' <i class="fa fa-pencil-square-o"></i>
            </b-button>
            <b-button id="btnFilter" @click="activecollapse" class="btn-pill" variant="default" size="sm">
...
<<<<<<< HEAD
        ...
        <b-modal id="ShowOrg" ref="ShowOrg" title="Chọn phòng ban" :lazy="true">
          <TreeVue :showcheckbox="showcheckbox" :data="data" :multiple="multiple" :size="size" :batch="batch" :whole="whole" :nodots="nodots" @item-click="itemclick($event)" :collapse="collapse"></TreeVue>
        </b-modal>
        <b-modal id="AddOrgTitle" ref="AddOrgTitle" size="lg" :hide-footer="true">
          <NewOrgTitle :data="listOrgTitle" :listGroup="listTitleGroup"></NewOrgTitle>
        </b-modal>
