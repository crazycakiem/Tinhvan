<template>
     <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-2">
                            <div class="img-fluid">
                                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCjxXK9Q7T1pM8Tik7tuthiF0IafU0VcPhCyav0_iTQmgdfaNUjA" />
                            </div>
                            <!--Hồ sơ nhân viên-->
                            <div>
                                <ul>
                                    <li @click="showEditExtension('HS')">EmployeeFile</li>
                                    <li @click="showEditExtension('GCNT')"> FamilyCircumstances</li>
                                    <li @click="showEditExtension('QTCT')"> WorkingProcess</li>
                                    <li @click="showEditExtension('QTL')"> WageProcess</li>
                                    <li @click="showEditExtension('QTHD')">ContractingProcess</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-10">
                            <b-collapse id="showHS" v-model="showHS">
                                <b-form>
                                    <b-row>
                                        <b-col cols="4">
                                            <b-button id="btnEdit" type="button" variant="primary" @click="onEdit">Submit</b-button>
                                ...
                                <b-form class="mform" v-if="showCode">
                                    <b-row class="mt-3 mb-2">
                                        <b-col cols="1">
                                            <label label-for="txtParent">Organization</label>
                                        </b-col>
                                        <b-col cols="2">
                                    ...
                                    <b-row class="mb-2">
                                        ...
                                        <b-col cols="2">
                                            <input id="txtSwipeCode" type="text" ref="parent" v-model="EmployeeUpdate.swipeCode" />
                                        </b-col>
                                        <b-col cols="1">
                                            <label label-for="txtBirthDay">BirthDay</label>
                                        </b-col>
                                        <b-col cols="3">
                                            <date-picker id="txtBirthDay" lang="en"
                                        ...
                                        <b-col cols="3">
                                            <input id="txtManager" type="text" ref="Manager" />
                                    ...
                                    <b-row class="mb-2">
                                        ...
                                        <b-col cols="2">
                                            <label id="lbTitle" v-for="item in dataTitle" :key="item.titleId" v-if="EmployeeUpdate.titleId==item.titleId">{{item.title.name}}</label>
                                        </b-col>
                                        <b-col cols="2">
                                            <label label-for="cboObject">{{  ('Object')}}</label>
                                        </b-col>
                                        <b-col cols="2">
                                            <select id="cboObject" >
                                    ...
                                    <b-row class="mb-2">
                                        ...
                                        <b-col cols="3">
                                            <date-picker id="txtDateID" lang="en"
                                                         format="DD-MM-YYYY" :clearable="false"></date-picker>
                                        </b-col>
                                        <b-col cols="1">
                                    ...
                                    <b-row class="mb-2">
                                        <b-col cols="2">BirthPlace</b-col>
                                        <b-col cols="10">
                                            <textarea id="txtNoiSinh" cols="100" >
                                            </textarea>
                                        </b-col>
                                        <b-col cols="2">PermanentAddress</b-col>
                                        <b-col cols="10">
                                            <textarea id="txtDiaChiThuongTru" cols="100">
                                            </textarea>
                                        </b-col>
                                    </b-row>
                                    <b-row class="mb-2">
                                        ...
                                        <b-col cols="2">
                                            <select id="cboPerCity"  v-on:change="changePerCity">
                                                <option v-for="item in dataPerCity" :key="item.id" :value="item.id">{{item.name}}</option>
                                            </select>
                                        </b-col>
                                        <b-col cols="2">District</b-col>
                                        <b-col cols="2">
                                            <select id="cboPerDistrict"  v-on:change="changePerDistrict">
                                                <option v-for="item in dataPerDistrict" :key="item.id" :value="item.id">{{item.name}}</option>
                                            </select>
                                        </b-col>
                                        <b-col cols="2">Ward</b-col>
                                        <b-col cols="2">
                                            <select id="cboPerWard" >
                                                <option v-for="item in dataPerWard" :key="item.id" :value="item.id">{{item.name}}</option>
                                            </select>
                                        </b-col>
                                    </b-row>
                                    <b-row class="mb-2">
                                        <b-col cols="2">TemporaryAddress</b-col>
                                        <b-col cols="10">
                                    ...
                                    <b-row class="mb-2">
                                        ...
                                        <b-col cols="2">
                                            <select id="cboTempCity"  v-on:change="changeTempCity">
                                                <option v-for="item in dataTempCity" :key="item.id" :value="item.id">{{item.name}}</option>
                                            </select>
                                        </b-col>
                                        <b-col cols="2">District</b-col>
                                        <b-col cols="2">
                                            <select id="cboTempDistrict"  v-on:change="changeTempDistrict">
                                                <option v-for="item in dataTempDistrict" :key="item.id" :value="item.id">{{item.name}}</option>
                                            </select>
                                        </b-col>
                                        <b-col cols="2">Ward</b-col>
                                        <b-col cols="2">
                                            <select id="cboTempWard">
                                                <option v-for="item in dataTempWard" :key="item.id" :value="item.id">{{item.name}}</option>
                                            </select>
                                        </b-col>
                                    </b-row>
                                    <b-row class="mb-2">
                                        <b-col cols="2">JoinDate</b-col>
                                        <b-col cols="2">

                                        </b-col>
                                        <b-col cols="2">JoinDateState</b-col>
                                        <b-col cols="2">

                                        </b-col>
                                        <b-col cols="2">WorkingStatus</b-col>
                                        <b-col cols="2">
                                ...
                                <b-form class="mform mb-3" v-if="showEmail">
                                    <b-row class="mb-3 mt-3">
                                        <b-col cols="2">CompanyEmail</b-col>
                                        <b-col cols="2">
                                            <input id="txtEmailCongTy" type="text"  />
                                        </b-col>
                                        <b-col cols="2">PersonalEmail</b-col>
                                        <b-col cols="2">
                                            <input id="txtEmailCaNhan" type="text" />
                                        </b-col>
                                    </b-row>
                                    <b-row class="mb-3">
                                        <b-col cols="3">PersonalPhone1</b-col>
                                        <b-col cols="2">
                                            <input id="txtSdtDd1" type="text" />
                                        </b-col>
                                        <b-col cols="3">PersonalPhone2</b-col>
                                        <b-col cols="2">
                                            <input id="txtSdtDd2" type="text"  />
                                        </b-col>
                                    </b-row>
                                    <b-row class="mb-3">
                                        <b-col cols="3"> <input id="cboCDP" type="checkbox"  />&nbsp;UnionFlee</b-col>
                                        <b-col cols="2">UnionDate</b-col>
                                        <b-col cols="2">
                                            <date-picker id="txtNgayVaoCongDoan" lang="en"
                                                         format="DD-MM-YYYY" :clearable="false"></date-picker>
                                        </b-col>
                                    </b-row>
                                    <b-row class="mb-3">
                                        ...
                                        <b-col cols="2">UnionPlace</b-col>
                                        <b-col cols="2">
                                            <input id="txtNoiVao" type="text"/>
                                        </b-col>
                                    </b-row>
                                    <b-row class="mb-3">
                                        <b-col cols="3"> <input id="cboCDP" type="checkbox"  />&nbsp; PartyFlee</b-col>
                                        <b-col cols="2">PartyDate</b-col>
                                        <b-col cols="2">
                                            <date-picker id="txtNgayVaoDang" lang="en"
                                                         format="DD-MM-YYYY" :clearable="false"></date-picker>
                                        </b-col>
                                    </b-row>
                                    <b-row>
                                    ...
                                    <b-row>
                                        ...
                                        <b-col cols="2">
                                           <select>
                                               <option v-for="item in dataHinhThucDaoTao" :key="item.id" :value="item.id">{{item.name}}</option>
                                           </select>
                                        </b-col>
                                    </b-row>
                                </b-form>
                            ...
                            <b-collapse id="showGCNT" v-model="showGCNT">
                                <EmployeeFamily :Id="Id" v-if="showGCNT">
                                </EmployeeFamily>
                            </b-collapse>
                            <b-collapse id="showQTCT" v-model="showQTCT">
                               <EmployeeWorkingProcess  :Id="Id" v-if="showQTCT">
                            ...
                            <b-collapse id="showQTHD" v-model="showQTHD">
                                <EmployeeContractProcess  :Id="Id" v-if="showQTHD">
