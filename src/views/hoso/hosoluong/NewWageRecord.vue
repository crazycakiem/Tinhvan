  ...
  <div>
    ...
    <b-form v-on:submit.prevent>
      <b-row class="mt-3">
        ...
        <b-col cols="2">
          ...
          <Autocomplete
            :items="items"
            :isAsync="true"
            ref="autocompleteEmployee"
            AutocompleteChangeEvent="AutocompleteEmployeeChange"
            AutocompleteSelected="AutocompleteEmployeeSelected"
          ></Autocomplete>
          <button @click="ShowPopUpEmployee">
            <i class="fa fa-search" aria-hidden="true"></i>
          </button>
        </b-col>
        <b-col cols="2">
          <label label-for="lbName">Tên nhân viên</label>
        </b-col>
        <b-col cols="2">
          <label ref="lbName">Hoàng văn hòa</label>
        </b-col>

        <b-col cols="2">
          <label label-for="lbOrg">Tổ chức</label>
        </b-col>
        <b-col cols="2">
          <label ref="lbOrg">Tinh vân Consultiong</label>
        </b-col>
      </b-row>
      <b-row class="mt-3">
        <b-col cols="2">Nhóm chức danh</b-col>
        <b-col cols="2">
          <label ref="lbTitleGroup">Chúc danh</label>
        </b-col>
        <b-col cols="2">Chức danh</b-col>
        <b-col cols="2">
          <label ref="lbTitle">Trưởng phòng</label>
        </b-col>
      </b-row>
      <b-row class="mt-3">
        <b-col cols="1">
        ...
        <b-col cols="2">
          <input id="txtQD" type="text" value="93483743489384">
        </b-col>
      </b-row>
      <b-row class="mt-3">
        <b-col cols="1">
      ...
      <b-row class="mt-3">
        ...
        <b-col cols="1">
          <label label-for="txtSalaryTotal">Tổng lương hưởng</label>
        </b-col>
        <b-col cols="2">
      ...
      <b-row class="mt-3">
        <button id="cboShowAll" class="btn btn-primary btn-custom" @click="changeShow">Phụ cấp</button>
      </b-row>
      <b-row>
      ...
      <b-row class="mt-3">
        <b-col cols="6">
          <b-button id="btnSubmit" type="submit" variant="primary" @click="onSubmit">Lưu</b-button>
          <b-button
