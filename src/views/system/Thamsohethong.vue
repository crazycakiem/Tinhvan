...
<template>
    <div>
        <h3>OtOtherList</h3>
        <div>
            <button id="btnAdd" @click="AddRow">
                <i class="fa fa-plus" aria-hidden="true" />
                <b-tooltip target="btnAdd" title="Add" />
            </button>
            <button id="btnApply" @click="Apply" v-if="checked">
                <i class="fa fa-lock" style="color:red" aria-hidden="true" />   
            </button>
            <button id="btnDenny" @click="Denny" v-if="checked">
                <i class="fa fa-unlock-alt" aria-hidden="true" />       
            </button>
            <button id="btnDelete" @click="Delete" v-if="checked">
                <i class="fa fa-close" aria-hidden="true" />             
            </button>
            <button id="btnFilter" class="m-1" @click="collapse">
        ...
        <div class="form-inline">
            <label for="cboDisplay">
                Show
            </label>
            <select id="cboDisplay" class="form-control" @change="$refs.tblOtherList.setLimit($event.target.value)">
        ...
        <v-client-table class="table-custom" ref="tblOtherList" :columns="columns" :options="options" :data="dataTable">
            ...
            <template slot="act" slot-scope="props">
                ...
                <button id="btnDeleteOne" class="btn btn-danger btn-custom" type="button" @click="DeleteOne(props.row)" v-if="props.row.readOrEdit==null" v-bind:ref="props.row.id+'*DeleteOne'">
