...
// Views - Hoso
const Hosonhanvien = () => import('@/views/hoso/employee/Hosonhanvien')
const Quanlyhosoluong = () => import('@/views/hoso/hosoluong/Quanlyhosoluong')
const Quanlyhopdong = () => import('@/views/hoso/contract/Quanlyhopdong')
const Quanlythaydoithongtinnhansu = () => import('@/views/hoso/thaydoithongtinnhansu/Quanlythaydoithongtinnhansu')
const Quanlydieuchuyen = () => import('@/views/hoso/dieuchuyen/Quanlydieuchuyen')
const Quanlynghiviec = () => import('@/views/hoso/terminate/Quanlynghiviec')
...
const NewContract = () => import('@/views/hoso/contract/NewContract')
const NewWageRecord = () => import('@/views/hoso/hosoluong/NewWageRecord')
...
const OrganizationTree = () => import('@/views/org/OrganizationTree')
//category
      ...
      children: [{
        ...
        },
        {
          ...
          children: [{
            ...
            {
              path: '/tochuc/caysodotochuc',
              name: 'Cây sơ đồ tổ chức',
